import{_ as s,c as n,o as a,a as e}from"./app-Cr4rVnZM.js";const l={},i=e(`<h1 id="nm" tabindex="-1"><a class="header-anchor" href="#nm"><span>nm</span></a></h1><p>Created by : Mr Dk.</p><p>2023 / 03 / 21 16:11</p><p>Hangzhou, Zhejiang, China</p><hr><h2 id="background" tabindex="-1"><a class="header-anchor" href="#background"><span>Background</span></a></h2><p><code>nm</code> 用于列出目标文件中的符号以及这些符号的性质。</p><h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage"><span>Usage</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="line">$ nm <span class="token parameter variable">--help</span></span>
