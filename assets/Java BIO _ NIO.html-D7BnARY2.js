import{_ as n,c as a,a as e,o as l}from"./app-DfFNXaa-.js";const i={};function c(t,s){return l(),a("div",null,[...s[0]||(s[0]=[e(`<h1 id="java-bio-nio" tabindex="-1"><a class="header-anchor" href="#java-bio-nio"><span>Java - BIO &amp; NIO</span></a></h1><p>Created by : Mr Dk.</p><p>2020 / 06 / 14 21:42</p><p>Nanjing, Jiangsu, China</p><hr><p>BIO 和 NIO 的概念很早之前就听说过，但没有机会深挖。最近下定决心弄清楚，有机缘巧合买了一节相关的网课听了听，觉得有些收获。把几个常用到的名词和含义搞懂了：</p><ul><li>BIO / NIO / AIO</li><li>SELECT / POLL / EPOLL</li><li>同步 / 异步</li><li>阻塞 / 非阻塞</li></ul><p>本文大致以服务端网络 I/O 操作的发展演进过程为逻辑。</p><hr><h2 id="bio" tabindex="-1"><a class="header-anchor" href="#bio"><span>BIO</span></a></h2><p>BIO 即 blocking I/O，这是操作系统中最简单的 I/O 模型。无论是在网络课还是在操作系统课上，无论是 Java 还是 C/C++，都肯定演示过一个最简单的网络程序 (伪代码)：</p><ul><li>监听一个服务器端口</li><li>在一个死循环中，不断接收客户端连接并处理</li><li>如果不想在处理连接的同时错过新的客户端连接，就把连接的处理交给一个子进程/子线程</li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">ServerSocket server = new ServerSocket(8080);</span>
...
<span class="line">    }</span>
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>ServerSocket 的实例化过程有三步：</p><ul><li>调用 OS 的 <code>socket()</code> 系统调用，拿到一个文件描述符 fd</li><li>调用 OS 的 <code>bind()</code> 将这个 fd 关联到服务器要监听的端口上</li><li>调用 OS 的 <code>listen()</code> 开始监听 fd (即监听端口)</li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">NAME</span>
