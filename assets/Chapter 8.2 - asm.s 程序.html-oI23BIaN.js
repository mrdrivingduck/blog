...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>以下汇编是 <strong>没有错误码</strong> 的异常处理过程 - eax 寄存器放置了对应 C 函数的地址：</p><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly"><pre><code class="language-assembly"><span class="line"># INT 0 - 除法出错</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>其余无错误码的异常，复用了标号为 <code>no_error_code</code> 的汇编代码：</p><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly"><pre><code class="language-assembly"><span class="line"># INT 1 - debug 调试中断入口点</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly"><pre><code class="language-assembly"><span class="line"># INT 2 - 非屏蔽中断调用入口</span>
...
<span class="line">    jmp no_error_code</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly"><pre><code class="language-assembly"><span class="line"># INT 3 - 断点指令引起的中断入口点</span>
<span class="line"># 由 INT 3 指令触发，通常由调试器插入被调试的代码中</span>
<span class="line">_int3:</span>
<span class="line">    pushl $_do_int3</span>
<span class="line">    jmp no_error_code</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly"><pre><code class="language-assembly"><span class="line"># INT 4 - 溢出出错处理中断入口点</span>
...
<span class="line">    jmp no_error_code</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly"><pre><code class="language-assembly"><span class="line"># INT 5 - 边界检查出错中断入口点</span>
<span class="line"># 操作数在有效范围以外时触发 - BOUND 指令</span>
<span class="line">_bounds:</span>
<span class="line">    pushl $_do_bounds</span>
<span class="line">    jmp no_error_code</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly"><pre><code class="language-assembly"><span class="line"># INT 6 - 无效操作指令出错中断入口点</span>
<span class="line"># CPU 执行机构检测到一个无效的操作码</span>
<span class="line">_invalid_op:</span>
<span class="line">    pushl $_do_invalid_op</span>
<span class="line">    jmp no_error_code</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly"><pre><code class="language-assembly"><span class="line"># INT 9 - 协处理器段超出中断入口点</span>
...
<span class="line">    jmp no_error_code</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly"><pre><code class="language-assembly"><span class="line"># INT 15 - 其它 Intel 保留中断的入口点</span>
<span class="line">_reserved:</span>
<span class="line">    pushl $_do_reserved</span>
<span class="line">    jmp no_error_code</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>下面是一个特殊的设置 - Linux 设置的数学协处理器硬件中断 INT 45：当协处理器执行完一个操作就会发出 IRQ 13 中断信号。80837 在执行计算时，CPU 会等待其操作完成，0xF0 是协处理器端口，用于清除忙锁存器，清除 CPU 的 BUSY 信号，重新激活 PEREQ。</p><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly"><pre><code class="language-assembly"><span class="line">_irq13:</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>以下汇编是 <strong>有错误码</strong> 的异常处理过程：</p><ul><li>eax 中放置了错误码</li><li>ebx 中放置了对应 C 函数的地址</li></ul><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly"><pre><code class="language-assembly"><span class="line"># INT 8 - 双出错故障</span>
...
<span class="line">    popl %eax</span>
<span class="line">    iret</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>其余产生错误码的异常，复用了标号为 <code>error_code</code> 的汇编代码：</p><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly"><pre><code class="language-assembly"><span class="line"># INT 10 - 无效的任务状态段 TSS</span>
<span class="line">_invalid_TSS:</span>
<span class="line">    pushl $_do_invalid_TSS</span>
<span class="line">    jmp error_code</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly"><pre><code class="language-assembly"><span class="line"># INT 11 - 段不存在</span>
...
<span class="line">    jmp error_code</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly"><pre><code class="language-assembly"><span class="line"># INT 12 - 堆栈段错误</span>
...
<span class="line">    jmp error_code</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly"><pre><code class="language-assembly"><span class="line"># INT 13 - 一般保护性出错</span>
...
<span class="line">    jmp error_code</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly"><pre><code class="language-assembly"><span class="line"># INT 17 - 边界对齐检查出错</span>
...
<span class="line">    jmp error_code</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>其余中断在别处被设置：</p><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly"><pre><code class="language-assembly"><span class="line"># INT 7 - 设备不存在 _device_not_available - kernel/sys_call.s</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,41)])])}const v=n(d,[["render",p]]),m=JSON.parse('{"path":"/linux-kernel-comments-notes/Chapter%208%20-%20%E5%86%85%E6%A0%B8%E4%BB%A3%E7%A0%81/Chapter%208.2%20-%20asm.s%20%E7%A8%8B%E5%BA%8F.html","title":"Chapter 8.2 - asm.s 程序","lang":"en-US","frontmatter":{},"git":{},"filePathRelative":"linux-kernel-comments-notes/Chapter 8 - 内核代码/Chapter 8.2 - asm.s 程序.md"}');export{v as comp,m as data};
