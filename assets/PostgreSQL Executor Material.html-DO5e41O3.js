import{_ as n,c as s,o as a,a as e}from"./app-DfdLUkTv.js";const l={},p=e(`<h1 id="postgresql-executor-material" tabindex="-1"><a class="header-anchor" href="#postgresql-executor-material"><span>PostgreSQL - Executor: Material</span></a></h1><p>Created by : Mr Dk.</p><p>2021 / 07 / 11 20:15</p><p>Hangzhou, Zhejiang, China</p><hr><p>该节点被翻译为 <strong>物化</strong> 节点，含义为将子计划中的元组缓存在当前节点中。如果子计划节点需要被反复访问，并且每次返回的元组都相同，那么对子计划返回的元组进行缓存可以提高性能。</p><h2 id="tuple-store" tabindex="-1"><a class="header-anchor" href="#tuple-store"><span>Tuple Store</span></a></h2><p>元组缓存使用 <code>Tuplestorestate</code> 结构，维护了用于缓存的内存空间和临时文件。之后准备专门分析一下和这个结构相关的代码。先明确几个相关 API 的功能：</p><ul><li><code>tuplestore_begin_heap</code> 构造并初始化存储结构</li><li><code>tuplestore_puttupleslot</code> 将元组 append 到 tuple store 的最后</li><li><code>tuplestore_gettupleslot</code> 从 tuple store 中读取元组</li><li><code>tuplestore_end</code> 释放 tuple store</li></ul><h2 id="plan-node" tabindex="-1"><a class="header-anchor" href="#plan-node"><span>Plan Node</span></a></h2><p>物化节点较为简单，直接继承自 <code>Plan</code> 结构：</p><div class="language-c line-numbers-mode" data-highlighter="prismjs" data-ext="c" data-title="c"><pre><code><span class="line"><span class="token comment">/* ----------------</span>
