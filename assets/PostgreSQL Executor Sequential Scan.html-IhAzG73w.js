import{_ as n,c as s,o as a,a as e}from"./app-DfdLUkTv.js";const l={},p=e(`<h1 id="postgresql-executor-sequential-scan" tabindex="-1"><a class="header-anchor" href="#postgresql-executor-sequential-scan"><span>PostgreSQL - Executor: Sequential Scan</span></a></h1><p>Created by : Mr Dk.</p><p>2021 / 06 / 27 23:42</p><p>Hangzhou, Zhejiang, China</p><hr><p>对 PostgreSQL 执行器的执行流程进行分析后，看看最简单的顺序扫描算子是如何实现的。</p><h2 id="plan-node" tabindex="-1"><a class="header-anchor" href="#plan-node"><span>Plan Node</span></a></h2><p>优化器输出的查询计划树是二叉树的形式。二叉树的节点有着最基本的结构定义，并根据不同类型的操作实现继承关系。最基本的计划树节点的结构定义如下。其中，由 <code>type</code> 来指定计划节点的类型。</p><div class="language-c line-numbers-mode" data-highlighter="prismjs" data-ext="c" data-title="c"><pre><code><span class="line"><span class="token comment">/* ----------------</span>
