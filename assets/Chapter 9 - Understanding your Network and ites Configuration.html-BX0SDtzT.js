import{_ as s,c as e,a,o as i}from"./app-DfFNXaa-.js";const l={};function c(r,n){return i(),e("div",null,[...n[0]||(n[0]=[a(`<h1 id="chapter-9-understanding-your-network-and-its-configuration" tabindex="-1"><a class="header-anchor" href="#chapter-9-understanding-your-network-and-its-configuration"><span>Chapter 9 - Understanding your Network and its Configuration</span></a></h1><p>Created by : Mr Dk.</p><p>2019 / 07 / 07 20:50</p><p>@NUAA, Nanjing, Jiangsu, China</p><hr><p>这章里的大部分知识以前上课都学过了</p><p>记几个常用命令拉倒了 😑</p><hr><h2 id="_9-4-routes-and-the-kernel-routing-table" tabindex="-1"><a class="header-anchor" href="#_9-4-routes-and-the-kernel-routing-table"><span>9.4 Routes and the Kernel Routing Table</span></a></h2><p>内核通过路由表决定将 packet 路由到何处：</p><div class="language-console line-numbers-mode" data-highlighter="prismjs" data-ext="console"><pre><code class="language-console"><span class="line">$ route -n</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><code>-n</code> 表示取消域名显示</li><li><code>-t</code> 表示只显示 TCP 连接</li></ul><h3 id="_9-14-2-establishing-tcp-connections" tabindex="-1"><a class="header-anchor" href="#_9-14-2-establishing-tcp-connections"><span>9.14.2 Establishing TCP Connections</span></a></h3><p>为了建立连接，必须有一个进程正在监听某个端口。通常来说，监听的端口都是提供熟知服务的，而发起连接的端口是动态分配的。查看所有正被监听的 TCP 端口：</p><div class="language-console line-numbers-mode" data-highlighter="prismjs" data-ext="console"><pre><code class="language-console"><span class="line">$ netstat -ntl</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_9-14-3-port-numbers-and-etc-services" tabindex="-1"><a class="header-anchor" href="#_9-14-3-port-numbers-and-etc-services"><span>9.14.3 Port Numbers and /etc/services</span></a></h3><p>在 <code>/etc/services</code> 中可以查到熟知端口号和对应的服务：</p><div class="language-console line-numbers-mode" data-highlighter="prismjs" data-ext="console"><pre><code class="language-console"><span class="line">$ cat /etc/services</span>
