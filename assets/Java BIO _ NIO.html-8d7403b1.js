import{_ as i,r as t,o as l,c,a as n,b as e,d as a,e as d}from"./app-25fa875f.js";const o={},r=d(`<h1 id="java-bio-nio" tabindex="-1"><a class="header-anchor" href="#java-bio-nio" aria-hidden="true">#</a> Java - BIO &amp; NIO</h1><p>Created by : Mr Dk.</p><p>2020 / 06 / 14 21:42</p><p>Nanjing, Jiangsu, China</p><hr><p>BIO 和 NIO 的概念很早之前就听说过，但没有机会深挖。最近下定决心弄清楚，有机缘巧合买了一节相关的网课听了听，觉得有些收获。把几个常用到的名词和含义搞懂了：</p><ul><li>BIO / NIO / AIO</li><li>SELECT / POLL / EPOLL</li><li>同步 / 异步</li><li>阻塞 / 非阻塞</li></ul><p>本文大致以服务端网络 I/O 操作的发展演进过程为逻辑。</p><hr><h2 id="bio" tabindex="-1"><a class="header-anchor" href="#bio" aria-hidden="true">#</a> BIO</h2><p>BIO 即 blocking I/O，这是操作系统中最简单的 I/O 模型。无论是在网络课还是在操作系统课上，无论是 Java 还是 C/C++，都肯定演示过一个最简单的网络程序 (伪代码)：</p><ul><li>监听一个服务器端口</li><li>在一个死循环中，不断接收客户端连接并处理</li><li>如果不想在处理连接的同时错过新的客户端连接，就把连接的处理交给一个子进程/子线程</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>ServerSocket server = new ServerSocket(8080);
while (true) {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>NAME
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>因此，BIO 的特性是：<strong>一个线程对应一个连接</strong>，能够解决的问题：</p><ul><li>可以接收大量的连接</li></ul><p>但是弊端在于，OS 中将会同时存在大量的线程：</p><ul><li>线程内存开销较大</li><li>大量的 CPU 资源被浪费在线程上下文切换上</li></ul><p>造成 BIO 特性的根本原因是，<strong>系统调用的阻塞性</strong>。如果系统调用能够支持非阻塞，那么就能够使用新的 I/O 模型。</p><h2 id="nio" tabindex="-1"><a class="header-anchor" href="#nio" aria-hidden="true">#</a> NIO</h2><p>OS 中的 NIO 指的是 non-blocking I/O，而 Java JDK 中的 <code>nio</code> 指的是 new I/O。在 Linux 2.6.27 起对 <code>socket()</code> 系统调用的非阻塞提供了支持：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Since Linux 2.6.27, the type argument serves a second purpose: in addition to specifying a socket type, it
...
server<span class="token punctuation">.</span><span class="token function">bind</span><span class="token punctuation">(</span><span class="token keyword">new</span> <span class="token class-name">InetSocketAddress</span><span class="token punctuation">(</span><span class="token number">9090</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token comment">// 所有客户端连接</span>
<span class="token class-name">LinkedList</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">SocketChannel</span><span class="token punctuation">&gt;</span></span> clients <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">LinkedList</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token punctuation">&gt;</span></span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token keyword">while</span> <span class="token punctuation">(</span><span class="token boolean">true</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span> <span class="token keyword">else</span> <span class="token punctuation">{</span>
        ...
        clients<span class="token punctuation">.</span><span class="token function">add</span><span class="token punctuation">(</span>client<span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// 维护客户端</span>
