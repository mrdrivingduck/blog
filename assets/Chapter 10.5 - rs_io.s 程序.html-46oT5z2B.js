import{_ as s,c as n,o as a,a as e}from"./app-zsROWd52.js";const l={},i=e(`<h1 id="chapter-10-5-rs-io-s-程序" tabindex="-1"><a class="header-anchor" href="#chapter-10-5-rs-io-s-程序"><span>Chapter 10.5 - rs_io.s 程序</span></a></h1><p>Created by : Mr Dk.</p><p>2019 / 08 / 26 19:15</p><p>Ningbo, Zhejiang, China</p><hr><h2 id="_10-5-rs-io-s-程序" tabindex="-1"><a class="header-anchor" href="#_10-5-rs-io-s-程序"><span>10.5 rs_io.s 程序</span></a></h2><h3 id="_10-5-1-功能描述" tabindex="-1"><a class="header-anchor" href="#_10-5-1-功能描述"><span>10.5.1 功能描述</span></a></h3><p>实现 RS-232 串行通信的中断处理过程。主要对终端设备的读、写缓冲队列进行操作：</p><ul><li>把从串行线路上收到的字符存入串行终端的读缓冲队列</li><li>或把写缓冲队列中需要发送的字符通过串行线路发送给远端的串行终端设备</li></ul><p>引起串行中断的原因有四种：</p><ol><li>modem 状态发生变化</li><li>线路状态发生变化</li><li>接收到字符</li><li>允许发送保持寄存器已空中断，需要发送字符</li></ol><p>前两种情况，只需要读取对应的状态寄存器，即可使其复位。对于接收到字符的情况，将字符放入读缓冲队列中，并调用行规则函数处理为字符行放入辅助队列中；对于需要发送字符的情况，程序首先从写缓冲队列中取出字符发送，并判断队列是否为空：</p><ul><li>若不为空，则循环发送过程</li><li>若为空，则禁止发送保持寄存器为空产生的中断</li></ul><h3 id="_10-5-2-代码注释" tabindex="-1"><a class="header-anchor" href="#_10-5-2-代码注释"><span>10.5.2 代码注释</span></a></h3><h4 id="几个常量的定义" tabindex="-1"><a class="header-anchor" href="#几个常量的定义"><span>几个常量的定义</span></a></h4><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly" data-title="assembly"><pre class="language-assembly"><code><span class="line">size = 1024 # 读写缓冲队列的长度</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="串口中断处理程序" tabindex="-1"><a class="header-anchor" href="#串口中断处理程序"><span>串口中断处理程序</span></a></h4><p>两个串行端口入口点不同，但共用处理逻辑：</p><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly" data-title="assembly"><pre class="language-assembly"><code><span class="line">.align 2</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="中断类型处理程序表" tabindex="-1"><a class="header-anchor" href="#中断类型处理程序表"><span>中断类型处理程序表</span></a></h4><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre class="language-text"><code><span class="line">jmp_table:</span>
<span class="line">    .long modem_status, write_char, read_char, line_status</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div><p>对于产生中断的四种类型，作分别的处理</p><h5 id="modem-状态变化中断" tabindex="-1"><a class="header-anchor" href="#modem-状态变化中断"><span>modem 状态变化中断</span></a></h5><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly" data-title="assembly"><pre class="language-assembly"><code><span class="line">.align 2</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="线路状态中断" tabindex="-1"><a class="header-anchor" href="#线路状态中断"><span>线路状态中断</span></a></h5><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly" data-title="assembly"><pre class="language-assembly"><code><span class="line">.align 2</span>
<span class="line">line_status:</span>
<span class="line">    addl $5, %edx</span>
<span class="line">    inb %dx, %al # 读线路状态寄存器，复位</span>
<span class="line">    ret</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="读字符中断" tabindex="-1"><a class="header-anchor" href="#读字符中断"><span>读字符中断</span></a></h5><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly" data-title="assembly"><pre class="language-assembly"><code><span class="line">.align 2</span>
...
<span class="line">    ret</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="写字符中断" tabindex="-1"><a class="header-anchor" href="#写字符中断"><span>写字符中断</span></a></h5><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly" data-title="assembly"><pre class="language-assembly"><code><span class="line">.align 2</span>
