import{_ as n,c as s,o as e,a}from"./app-DfdLUkTv.js";const i={},l=a(`<h1 id="docker-volume-network-usage" tabindex="-1"><a class="header-anchor" href="#docker-volume-network-usage"><span>Docker - Volume &amp; Network Usage</span></a></h1><p>Created by : Mr Dk.</p><p>2020 / 09 / 08 23:04</p><p>Nanjing, Jiangsu, China</p><hr><p>通过一个最简单的例子来了解 Docker 中的 <strong>卷 (volume)</strong> 和网络。例子很简单：在 Docker 中运行一个 Nginx，Nginx 的静态资源目录 (比如网页代码) 位于宿主机上，并以卷的形式挂在到容器中。然后在宿主机上访问容器中的 Nginx 监听的端口。</p><h2 id="准备工作" tabindex="-1"><a class="header-anchor" href="#准备工作"><span>准备工作</span></a></h2><p>首先准备一个能够在容器中启动 Nginx 的镜像：</p><ol><li>准备好操作系统 (基础镜像)，并安装 Nginx</li><li>将 Nginx 的配置文件在宿主机上提前准备好，使用 <code>ADD</code> 指令复制到镜像中</li><li>指明从镜像启动的容器暴露自己的 <code>80</code> 端口</li></ol><p>其余上述思想，实现了一个 Dockerfile。Dockerfile 所在目录的组织方式如下：</p><div class="language-console line-numbers-mode" data-highlighter="prismjs" data-ext="console" data-title="console"><pre><code><span class="line">$ tree -a</span>
