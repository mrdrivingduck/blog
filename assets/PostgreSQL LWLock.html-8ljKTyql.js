import{_ as l,r as i,c as t,b as n,e as s,d as e,w as p,a as c,o}from"./app-DfdLUkTv.js";const u={},r=n("h1",{id:"postgresql-lwlock",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#postgresql-lwlock"},[n("span",null,"PostgreSQL - LWLock")])],-1),d=n("p",null,"Created by: Mr Dk.",-1),k=n("p",null,"2023 / 11 / 29 16:40",-1),v=n("p",null,"Hangzhou, Zhejiang, China",-1),m=n("hr",null,null,-1),b=n("h2",{id:"background",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#background"},[n("span",null,"Background")])],-1),h=c(`<p>本文基于 PostgreSQL <code>master</code> 分支（PostgreSQL 17 under dev）当前的 <code>HEAD</code> 版本分析原子操作的实现：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">commit 15c9ac3629936a9bb5010155d3656e913027ccb7</span>
