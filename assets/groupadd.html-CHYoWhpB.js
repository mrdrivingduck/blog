import{_ as n,c as a,a as e,o as l}from"./app-CT9FvwxE.js";const i={};function p(d,s){return l(),a("div",null,s[0]||(s[0]=[e(`<h1 id="groupadd" tabindex="-1"><a class="header-anchor" href="#groupadd"><span>groupadd</span></a></h1><p>Created by : Mr Dk.</p><p>2023 / 02 / 06 22:55</p><p>Hangzhou, Zhejiang, China</p><hr><h2 id="background" tabindex="-1"><a class="header-anchor" href="#background"><span>Background</span></a></h2><p><code>groupadd</code> 用于创建一个用户组。在 Linux 中，从用户级别来维护各个用户的权限比较麻烦，所以引入了 <strong>用户组</strong> 的概念，可以通过为用户组赋权从而给组内所有的用户赋权。</p><h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage"><span>Usage</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">$ <span class="token function">groupadd</span> <span class="token parameter variable">-h</span></span>
