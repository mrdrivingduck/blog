import{_ as i,c as t,b as s,e as a,d as p,w as l,a as c,r as o,o as u}from"./app-DfFNXaa-.js";const r={};function d(k,n){const e=o("RouteLink");return u(),t("div",null,[n[5]||(n[5]=s("h1",{id:"postgresql-lwlock",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#postgresql-lwlock"},[s("span",null,"PostgreSQL - LWLock")])],-1)),n[6]||(n[6]=s("p",null,"Created by: Mr Dk.",-1)),n[7]||(n[7]=s("p",null,"2023 / 11 / 29 16:40",-1)),n[8]||(n[8]=s("p",null,"Hangzhou, Zhejiang, China",-1)),n[9]||(n[9]=s("hr",null,null,-1)),n[10]||(n[10]=s("h2",{id:"background",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#background"},[s("span",null,"Background")])],-1)),s("p",null,[n[2]||(n[2]=a("PostgreSQL 中的轻量级锁 LWLock（Light Weight Lock）用于互斥访问共享内存中的数据结构。与 ",-1)),p(e,{to:"/notes/PostgreSQL/PostgreSQL%20Atomics.html"},{default:l(()=>[...n[0]||(n[0]=[a("原子操作",-1)])]),_:1}),n[3]||(n[3]=a(" 和 ",-1)),p(e,{to:"/notes/PostgreSQL/PostgreSQL%20Spinlock.html"},{default:l(()=>[...n[1]||(n[1]=[a("自旋锁",-1)])]),_:1}),n[4]||(n[4]=a(" 不同，LWLock 引入了读写访问模式，使其可以被不同进程共享访问或排它访问。实际上 LWLock 就是结合原子操作和自旋实现的，也引入了信号量。另外 LWLock 也支持对某个共享变量的值进行修改和监视，但应用场景相对较少。",-1))]),n[11]||(n[11]=c(`<p>本文基于 PostgreSQL <code>master</code> 分支（PostgreSQL 17 under dev）当前的 <code>HEAD</code> 版本分析原子操作的实现：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">commit 15c9ac3629936a9bb5010155d3656e913027ccb7</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>LWLock 的锁模式：</p><div class="language-c line-numbers-mode" data-highlighter="prismjs" data-ext="c"><pre><code class="language-c"><span class="line"><span class="token keyword">typedef</span> <span class="token keyword">enum</span> <span class="token class-name">LWLockMode</span></span>
<span class="line"><span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>LWLock 的锁状态位：</p><ul><li><code>LW_FLAG_HAS_WAITERS</code>：是否存在等待进程</li><li><code>LW_FLAG_RELEASE_OK</code>：在释放锁时立刻唤醒等待进程</li><li><code>LW_FLAG_LOCKED</code>：正在修改 LWLock 内的等待进程列表</li></ul><div class="language-c line-numbers-mode" data-highlighter="prismjs" data-ext="c"><pre><code class="language-c"><span class="line"><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">define</span> <span class="token macro-name">LW_FLAG_HAS_WAITERS</span>         <span class="token expression"><span class="token punctuation">(</span><span class="token punctuation">(</span>uint32<span class="token punctuation">)</span> <span class="token number">1</span> <span class="token operator">&lt;&lt;</span> <span class="token number">30</span><span class="token punctuation">)</span></span></span></span>
...
<span class="line">    <span class="token punctuation">}</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,45))])}const m=i(r,[["render",d]]),b=JSON.parse('{"path":"/notes/PostgreSQL/PostgreSQL%20LWLock.html","title":"PostgreSQL - LWLock","lang":"en-US","frontmatter":{},"git":{},"filePathRelative":"notes/PostgreSQL/PostgreSQL LWLock.md"}');export{m as comp,b as data};
