...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="标志字节" tabindex="-1"><a class="header-anchor" href="#标志字节"><span>标志字节</span></a></h4><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly"><pre><code class="language-assembly"><span class="line">mode: .byte 0 # 键盘特殊键的按下状态标志 ctrl/alt/caps/shift</span>
<span class="line">leds: .byte 2 # 键盘指示灯状态标志 num-lock/caps/...</span>
<span class="line">e0: .byte 0 # 扫描前导码标志，扫描码为 0xe0/0xe1</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="键盘中断处理程序" tabindex="-1"><a class="header-anchor" href="#键盘中断处理程序"><span>键盘中断处理程序</span></a></h4><p>键盘控制器收到用户的按键操作时，向中断控制器发出键盘中断请求信号 IRQ1。CPU 响应该请求后，进入键盘中断处理程序。该程序从键盘控制器端口 0x60 读入键盘扫描码，并调用对应的扫描码子程序进行处理：</p><ol><li>若当前扫描码为 0xe0 或 0xe1，就立刻对键盘控制器作出应答，并向中断控制器发送 EOI 信号</li><li>否则根据扫描码调用对应的按键处理子程序，把扫描码放入读缓冲队列中</li><li>对键盘控制器作出应答，发送 EOI 信号</li><li>调用 <code>do_tty_interrupt()</code>，将读缓冲队列的字符放到辅助队列中</li></ol><div class="language-assembly line-numbers-mode" data-highlighter="prismjs" data-ext="assembly"><pre><code class="language-assembly"><span class="line">_keyboard_interrupt:</span>
