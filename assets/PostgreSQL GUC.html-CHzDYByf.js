import{_ as n,c as a,a as e,o as l}from"./app-7eKjwDat.js";const i={};function p(c,s){return l(),a("div",null,s[0]||(s[0]=[e(`<h1 id="postgresql-guc" tabindex="-1"><a class="header-anchor" href="#postgresql-guc"><span>PostgreSQL - GUC</span></a></h1><p>Created by : Mr Dk.</p><p>2021 / 05 / 30 21:45</p><p>Hangzhou, Zhejiang, China</p><hr><h2 id="about" tabindex="-1"><a class="header-anchor" href="#about"><span>About</span></a></h2><p><em>GUC (Grand Unified Configuration)</em> 是 <em>PostgreSQL</em> 的配置系统。负责在不同时机从多个来源、以多种方式控制数据库的所有配置项。</p><h2 id="time" tabindex="-1"><a class="header-anchor" href="#time"><span>Time</span></a></h2><p>特定的配置项只能在特定的时间被设置，分类如下：</p><div class="language-c line-numbers-mode" data-highlighter="prismjs" data-ext="c" data-title="c"><pre><code><span class="line"><span class="token keyword">typedef</span> <span class="token keyword">enum</span></span>
