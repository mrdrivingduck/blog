import{_ as e,o as s,c as n,e as i}from"./app-25fa875f.js";const t={},d=i(`<h1 id="chapter-10-network-applications-and-services" tabindex="-1"><a class="header-anchor" href="#chapter-10-network-applications-and-services" aria-hidden="true">#</a> Chapter 10 - Network Applications and Services</h1><p>Created by : Mr Dk.</p><p>2019 / 07 / 09 23:58</p><p>@NUAA, Nanjing, Jiangsu, China</p><hr><p>又是水得不行的一章... 🤨</p><h2 id="_10-2-network-servers" tabindex="-1"><a class="header-anchor" href="#_10-2-network-servers" aria-hidden="true">#</a> 10.2 Network Servers</h2><ul><li><em>httpd</em>, <em>apache</em>, <em>apache2</em>：Web servers</li><li><em>sshd</em>：Secure shell</li><li><em>postfix</em>, <em>qmail</em>, <em>sendmail</em>：Mail servers</li><li><em>cupsd</em>：Print server</li><li><em>nfsd</em>, <em>mountd</em>：Network filesystem daemons</li><li><em>smbd</em>, <em>nmbd</em>：WIndows file-sharing daemons</li><li><em>rpcbind</em>：Remote procedure call (RPC) portmap service deamon</li></ul><p>网络服务器的共同特征：多进程。</p><ul><li>至少一个进程监听端口</li><li>当接收到连接后，监听进程使用 <code>fork()</code> 创建新的子进程处理连接</li><li>同时，监听进程继续监听端口</li></ul><p>其中，调用 <code>fork()</code> 给系统带来了较大开销。因此，一些高性能的 TCP 服务器会在启动时创建大量工作进程：worker process。</p><h2 id="_10-3-secure-shell-ssh" tabindex="-1"><a class="header-anchor" href="#_10-3-secure-shell-ssh" aria-hidden="true">#</a> 10.3 Secure Shell (SSH)</h2><p>支持远程登录、程序执行、文件共享。使用公钥密码体制替代了老旧的、不安全的 <code>telnet</code> 和 <code>rlogin</code>。<em>OpenSSH</em> 是最受欢迎的免费 SSH 实现。</p><h3 id="_10-3-1-the-sshd-server" tabindex="-1"><a class="header-anchor" href="#_10-3-1-the-sshd-server" aria-hidden="true">#</a> 10.3.1 The SSHD Server</h3><p>运行 <code>sshd</code> 服务需要一个配置文件和密钥：<code>/etc/ssh</code></p><ul><li>服务器配置文件：<code>sshd_config</code></li><li>客户端配置文件：<code>ssh_config</code></li></ul><p>服务器配置文件中可以配置监听端口和密钥路径。</p><h4 id="host-keys" tabindex="-1"><a class="header-anchor" href="#host-keys" aria-hidden="true">#</a> Host Keys</h4><p>SSH version 1 只有 RSA 密钥，SSH version 2 有 RSA 和 DSA 密钥。使用 <code>ssh-keygen</code> 可以生成公私钥对。</p><h3 id="_10-3-2-the-ssh-client" tabindex="-1"><a class="header-anchor" href="#_10-3-2-the-ssh-client" aria-hidden="true">#</a> 10.3.2 The SSH Client</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">ssh</span> username@host
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>在 <code>.ssh/known_hosts</code> 中保存了远程服务器的公钥。如果远程服务器的公钥与以前的公钥发生了冲突，比如替换了硬件或操作系统，将会产生警告。将以前的公钥记录删除即可。</p><h4 id="ssh-file-transfer-clients" tabindex="-1"><a class="header-anchor" href="#ssh-file-transfer-clients" aria-hidden="true">#</a> SSH File Transfer Clients</h4><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">scp</span> user1@host1:file user2@host2:dir
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><code>sftp</code> 使用 <code>get</code> 和 <code>put</code> 命令，服务器需要运行 <code>sftp-server</code>。</p><h2 id="_10-4-the-inetd-and-xinetd-daemons" tabindex="-1"><a class="header-anchor" href="#_10-4-the-inetd-and-xinetd-daemons" aria-hidden="true">#</a> 10.4 The inetd and xinetd Daemons</h2><p>为了避免分别运行每种服务的麻烦，<code>inetd</code> 读取配置文件，监听对应的端口。当接受到连接时，<code>inetd</code> 将连接分配到对应的进程。</p><h2 id="_10-5-diagnostic-tools" tabindex="-1"><a class="header-anchor" href="#_10-5-diagnostic-tools" aria-hidden="true">#</a> 10.5 Diagnostic Tools</h2><h3 id="_10-5-1-lsof" tabindex="-1"><a class="header-anchor" href="#_10-5-1-lsof" aria-hidden="true">#</a> 10.5.1 lsof</h3><p><code>lsof</code> 可用于追踪所有打开的文件，也可以查看所有正在监听端口的程序：</p><div class="language-console line-numbers-mode" data-ext="console"><pre class="language-console"><code>$ lsof -i
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用 <code>-n</code> 选项禁止 IP 地址和熟知端口的反向解析：</p><div class="language-console line-numbers-mode" data-ext="console"><pre class="language-console"><code>$ lsof -n -i
COMMAND     PID            USER   FD   TYPE  DEVICE SIZE/OFF NODE NAME
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>并可以使用各种过滤规则。</p><h3 id="_10-5-2-tcpdump" tabindex="-1"><a class="header-anchor" href="#_10-5-2-tcpdump" aria-hidden="true">#</a> 10.5.2 tcpdump</h3><h3 id="_10-5-3-netcat" tabindex="-1"><a class="header-anchor" href="#_10-5-3-netcat" aria-hidden="true">#</a> 10.5.3 netcat</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>netcat <span class="token function">host</span> port
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>监听一个特定端口：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>netcat <span class="token parameter variable">-l</span> <span class="token parameter variable">-p</span> port_number
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_10-5-4-port-scanning" tabindex="-1"><a class="header-anchor" href="#_10-5-4-port-scanning" aria-hidden="true">#</a> 10.5.4 Port Scanning</h3><p>Network Mapper (Nmap) 程序可以扫描一台机器所有开放的端口：</p><div class="language-console line-numbers-mode" data-ext="console"><pre class="language-console"><code>$ nmap 103.235.46.39
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_10-6-remote-procedure-call-rpc" tabindex="-1"><a class="header-anchor" href="#_10-6-remote-procedure-call-rpc" aria-hidden="true">#</a> 10.6 Remote Procedure Call (RPC)</h2><p>在远程机器上调用函数，并返回一个结果码或消息。RPC 的实现需要将程序编号和传输层端口号映射。</p><h2 id="_10-9-sockets-how-processes-communicate-with-the-network" tabindex="-1"><a class="header-anchor" href="#_10-9-sockets-how-processes-communicate-with-the-network" aria-hidden="true">#</a> 10.9 Sockets: How Processes Communicate with the Network</h2><p>Socket 是进程通过内核访问网络的接口，表示了用户空间和内核之间的界限，也被用于进程间通信 (inter-process communication, IPC)。有多种不同类型的 socket：</p><ul><li>stream socket：<code>SOCK_STREAM</code> 用于 TCP</li><li>datagram sockets：<code>SOCK_DGRAM</code> 用于 UDP</li></ul><h2 id="_10-10-unix-domain-sockets" tabindex="-1"><a class="header-anchor" href="#_10-10-unix-domain-sockets" aria-hidden="true">#</a> 10.10 Unix Domain Sockets</h2><p>在同一台机器上运行的进程，使用进程间通信进行沟通。进程使用本地 IP 地址 <em>localhost</em> 进行通信，使用的是一种特殊类型的 socket：Unix domain socket。Unix domain socket 实际上没有使用网络，甚至都不需要网络被配置就能使用，也不需要绑定任何的 socket 文件。进程创建的未命名 socket 可以直接通过地址被其它进程共享。</p><h3 id="_10-10-1-advantages-for-developers" tabindex="-1"><a class="header-anchor" href="#_10-10-1-advantages-for-developers" aria-hidden="true">#</a> 10.10.1 Advantages for Developers</h3><ul><li>便于访问控制</li><li>不需要进入协议栈，性能更好</li></ul><h3 id="_10-10-2-listing-unix-domain-sockets" tabindex="-1"><a class="header-anchor" href="#_10-10-2-listing-unix-domain-sockets" aria-hidden="true">#</a> 10.10.2 Listing Unix Domain Sockets</h3><p>查看所有的 Unix domain sockets：</p><div class="language-console line-numbers-mode" data-ext="console"><pre class="language-console"><code>$ lsof -U
COMMAND     PID             USER   FD   TYPE             DEVICE SIZE/OFF    NODE NAME
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,54),u=[d];function r(a,f){return s(),n("div",null,u)}const l=e(t,[["render",r],["__file","Chapter 10 - Network Applications and Services.html.vue"]]);export{l as default};
