import{_ as a,c as n,a as e,o as l}from"./app-DfFNXaa-.js";const i={};function p(t,s){return l(),n("div",null,[...s[0]||(s[0]=[e(`<h1 id="cut" tabindex="-1"><a class="header-anchor" href="#cut"><span>cut</span></a></h1><p>Created by : Mr Dk.</p><p>2022 / 12 / 01 23:56</p><p>Hangzhou, Zhejiang, China</p><hr><h2 id="background" tabindex="-1"><a class="header-anchor" href="#background"><span>Background</span></a></h2><p><code>cut</code> 用于从每行文本中挑选出想要的内容。</p><h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage"><span>Usage</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">$ <span class="token function">cut</span> <span class="token parameter variable">--help</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>测试文件：</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">$ <span class="token function">cat</span> example.txt</span>
<span class="line">aaa bb cccc</span>
<span class="line"><span class="token function">dd</span> e fffff</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="按字节定位" tabindex="-1"><a class="header-anchor" href="#按字节定位"><span>按字节定位</span></a></h3><p><code>-b</code> 参数指示在每行中取出想要的字节（1 表示第一个字节）。其参数可以有如下形式：</p><ul><li>逗号分隔的枚举值</li><li>具有左右边界的范围</li><li>没有左边界的范围（从第一个字节到右边界）</li><li>没有右边界的范围（从左边界到最后一个字节）</li></ul><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">$ <span class="token function">cut</span> <span class="token parameter variable">-b</span> <span class="token number">1,3</span>,5 example.txt</span>
...
<span class="line">aaa</span>
<span class="line"><span class="token function">dd</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="按字符定位" tabindex="-1"><a class="header-anchor" href="#按字符定位"><span>按字符定位</span></a></h3><p><code>-c</code> 参数指示在每行中取出想要的字符，使用方式与 <code>-b</code> 类似。</p><h3 id="按-field-定位" tabindex="-1"><a class="header-anchor" href="#按-field-定位"><span>按 field 定位</span></a></h3><p><code>-f</code> 参数按特定分隔符来选择每一行中的 field。分隔符默认为 TAB，但可以使用 <code>-d</code> 参数指定：</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">$ <span class="token function">cut</span> <span class="token parameter variable">-f</span> <span class="token number">2</span> <span class="token parameter variable">-d</span> <span class="token string">&#39; &#39;</span> example.txt</span>
<span class="line">bb</span>
<span class="line">e</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果分隔符不存在，那么这一行也会被打印出来，除非使用 <code>-s</code> 参数。</p><h3 id="取反" tabindex="-1"><a class="header-anchor" href="#取反"><span>取反</span></a></h3><p>使用 <code>--complement</code> 用于选择出不在范围以内的所有信息：</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">$ <span class="token function">cut</span> <span class="token parameter variable">--complement</span> <span class="token parameter variable">-f</span> <span class="token number">2</span> <span class="token parameter variable">-d</span> <span class="token string">&#39; &#39;</span> example.txt</span>
<span class="line">aaa cccc</span>
<span class="line"><span class="token function">dd</span> fffff</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="输出分隔符" tabindex="-1"><a class="header-anchor" href="#输出分隔符"><span>输出分隔符</span></a></h3><p>使用 <code>--output-delimiter</code> 指定输出的分隔符：</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">$ <span class="token function">cut</span> <span class="token parameter variable">--complement</span> --output-delimiter <span class="token string">&#39;:&#39;</span> <span class="token parameter variable">-f</span> <span class="token number">2</span> <span class="token parameter variable">-d</span> <span class="token string">&#39; &#39;</span> example.txt</span>
<span class="line">aaa:cccc</span>
<span class="line">dd:fffff</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="references" tabindex="-1"><a class="header-anchor" href="#references"><span>References</span></a></h2><p><a href="https://www.geeksforgeeks.org/cut-command-linux-examples/" target="_blank" rel="noopener noreferrer">cut command in Linux with examples</a></p><p><a href="https://man7.org/linux/man-pages/man1/cut.1.html" target="_blank" rel="noopener noreferrer">cut(1) — Linux manual page</a></p>`,30)])])}const r=a(i,[["render",p]]),d=JSON.parse('{"path":"/notes/Linux/cut.html","title":"cut","lang":"en-US","frontmatter":{},"git":{},"filePathRelative":"notes/Linux/cut.md"}');export{r as comp,d as data};
