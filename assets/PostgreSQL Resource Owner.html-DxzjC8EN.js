...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当需要记录资源时，先将资源放入定长数组中；如果数组满了，就将定长数组中的所有内容移入哈希表；当哈希表的容量达到阈值时还需要扩容哈希表。在查找资源时，需要搜索定长数组和哈希表。</p><p>设置一个定长数组的原因是，大部分资源使用的生命周期很短，因此可以在定长数组中快速地线性搜索资源并移除记录。</p><h2 id="资源释放和泄漏检测" tabindex="-1"><a class="header-anchor" href="#资源释放和泄漏检测"><span>资源释放和泄漏检测</span></a></h2><p>事务结束时，通过下面的函数确保资源释放：</p><div class="language-c line-numbers-mode" data-highlighter="prismjs" data-ext="c"><pre><code class="language-c"><span class="line"><span class="token keyword">extern</span> <span class="token keyword">void</span> <span class="token function">ResourceOwnerRelease</span><span class="token punctuation">(</span>ResourceOwner owner<span class="token punctuation">,</span></span>
