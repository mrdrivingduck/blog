import{_ as n,c as a,o as s,a as e}from"./app-DfdLUkTv.js";const l={},i=e(`<h1 id="head-tail" tabindex="-1"><a class="header-anchor" href="#head-tail"><span>head / tail</span></a></h1><p>Created by : Mr Dk.</p><p>2022 / 11 / 02 23:28</p><p>Hangzhou, Zhejiang, China</p><hr><h2 id="background" tabindex="-1"><a class="header-anchor" href="#background"><span>Background</span></a></h2><p><code>head</code> 和 <code>tail</code> 被用于打印文件的开头部分和结尾部分至标准输出流。</p><h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage"><span>Usage</span></a></h2><p>默认打印 10 行：</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">$ <span class="token function">head</span> a.txt</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code>--pid=PID</code> 在指定进程退出后结束追踪模式。</p><p><code>-s</code> 指定追踪文件过程中的睡眠时间。</p><h2 id="references" tabindex="-1"><a class="header-anchor" href="#references"><span>References</span></a></h2><p><a href="https://man7.org/linux/man-pages/man1/head.1.html" target="_blank" rel="noopener noreferrer">head(1) — Linux manual page</a></p><p><a href="https://man7.org/linux/man-pages/man1/tail.1.html" target="_blank" rel="noopener noreferrer">tail(1) — Linux manual page</a></p>`,22),p=[i];function c(d,r){return s(),a("div",null,p)}const o=n(l,[["render",c],["__file","head-tail.html.vue"]]),v=JSON.parse('{"path":"/notes/Linux/head-tail.html","title":"head / tail","lang":"en-US","frontmatter":{},"headers":[{"level":2,"title":"Background","slug":"background","link":"#background","children":[]},{"level":2,"title":"Usage","slug":"usage","link":"#usage","children":[]},{"level":2,"title":"Following","slug":"following","link":"#following","children":[]},{"level":2,"title":"References","slug":"references","link":"#references","children":[]}],"git":{"updatedTime":null,"contributors":[]},"filePathRelative":"notes/Linux/head-tail.md"}');export{o as comp,v as data};
