import{_ as a,c as n,a as e,o as i}from"./app-DfFNXaa-.js";const l={};function p(r,s){return i(),n("div",null,[...s[0]||(s[0]=[e(`<h1 id="readlink" tabindex="-1"><a class="header-anchor" href="#readlink"><span>readlink</span></a></h1><p>Created by : Mr Dk.</p><p>2023 / 04 / 14 19:55</p><p>Hangzhou, Zhejiang, China</p><hr><h2 id="background" tabindex="-1"><a class="header-anchor" href="#background"><span>Background</span></a></h2><p><code>realpath</code> 能够返回任意路径的绝对路径。</p><h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage"><span>Usage</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">$ realpath <span class="token parameter variable">--help</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对于符号链接来说，<code>-s</code> 选项可以选择不展开符号链接：</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">$ <span class="token function">ln</span> <span class="token parameter variable">-s</span> polar-doc/docs/README.md README</span>
<span class="line"></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="references" tabindex="-1"><a class="header-anchor" href="#references"><span>References</span></a></h2><p><a href="https://linux.die.net/man/1/realpath" target="_blank" rel="noopener noreferrer">realpath(1) - Linux man page</a></p>`,20)])])}const c=a(l,[["render",p]]),d=JSON.parse('{"path":"/notes/Linux/realpath.html","title":"readlink","lang":"en-US","frontmatter":{},"git":{},"filePathRelative":"notes/Linux/realpath.md"}');export{c as comp,d as data};
