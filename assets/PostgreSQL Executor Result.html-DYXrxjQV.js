import{_ as n,c as s,o as a,a as e}from"./app-zsROWd52.js";const l={},p=e(`<h1 id="postgresql-executor-result" tabindex="-1"><a class="header-anchor" href="#postgresql-executor-result"><span>PostgreSQL - Executor: Result</span></a></h1><p>Created by : Mr Dk.</p><p>2021 / 07 / 04 16:41</p><p>Hangzhou, Zhejiang, China</p><hr><p>Result 节点的作用，概括来说用于承载表达式的执行结果。细分有两种用途：</p><ul><li>承载不需要进行表扫描的 SQL 语句执行结果</li><li>承载常量选择条件的执行结果，用于优化选择条件为常量的查询</li></ul><p>不用进行表扫描的 SQL 语句包括没有 <code>FROM</code> 的 <code>SELECT</code> 语句，或者带有 <code>VALUES</code> 的元组构造语句：</p><div class="language-sql line-numbers-mode" data-highlighter="prismjs" data-ext="sql" data-title="sql"><pre class="language-sql"><code><span class="line"><span class="token keyword">select</span> <span class="token number">1</span> <span class="token operator">*</span> <span class="token number">2</span><span class="token punctuation">;</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div><p>查询条件为常量的查询。此时，表达式的结果只需要被计算一次：如果计算为假，那么相当于直接进行一次过滤，不再需要查询出每个元组之后再和查询条件进行判断了。</p><div class="language-sql line-numbers-mode" data-highlighter="prismjs" data-ext="sql" data-title="sql"><pre class="language-sql"><code><span class="line"><span class="token keyword">select</span> <span class="token operator">*</span> <span class="token keyword">from</span> emp <span class="token keyword">where</span> <span class="token number">2</span> <span class="token operator">&gt;</span> <span class="token number">1</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><div class="language-c line-numbers-mode" data-highlighter="prismjs" data-ext="c" data-title="c"><pre class="language-c"><code><span class="line"><span class="token comment">/*-------------------------------------------------------------------------</span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,28),i=[p];function t(c,o){return a(),s("div",null,i)}const d=n(l,[["render",t],["__file","PostgreSQL Executor Result.html.vue"]]),r=JSON.parse('{"path":"/notes/PostgreSQL/PostgreSQL%20Executor%20Result.html","title":"PostgreSQL - Executor: Result","lang":"en-US","frontmatter":{},"headers":[{"level":2,"title":"Plan Node","slug":"plan-node","link":"#plan-node","children":[]},{"level":2,"title":"Initialization","slug":"initialization","link":"#initialization","children":[]},{"level":2,"title":"Execution","slug":"execution","link":"#execution","children":[]},{"level":2,"title":"End","slug":"end","link":"#end","children":[]}],"git":{"updatedTime":null,"contributors":[]},"filePathRelative":"notes/PostgreSQL/PostgreSQL Executor Result.md"}');export{d as comp,r as data};
