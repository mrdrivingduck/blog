import{_ as n,c as s,o as a,a as e}from"./app-Cr4rVnZM.js";const l={},p=e(`<h1 id="postgresql-executor-result" tabindex="-1"><a class="header-anchor" href="#postgresql-executor-result"><span>PostgreSQL - Executor: Result</span></a></h1><p>Created by : Mr Dk.</p><p>2021 / 07 / 04 16:41</p><p>Hangzhou, Zhejiang, China</p><hr><p>Result 节点的作用，概括来说用于承载表达式的执行结果。细分有两种用途：</p><ul><li>承载不需要进行表扫描的 SQL 语句执行结果</li><li>承载常量选择条件的执行结果，用于优化选择条件为常量的查询</li></ul><p>不用进行表扫描的 SQL 语句包括没有 <code>FROM</code> 的 <code>SELECT</code> 语句，或者带有 <code>VALUES</code> 的元组构造语句：</p><div class="language-sql line-numbers-mode" data-highlighter="prismjs" data-ext="sql" data-title="sql"><pre class="language-sql"><code><span class="line"><span class="token keyword">select</span> <span class="token number">1</span> <span class="token operator">*</span> <span class="token number">2</span><span class="token punctuation">;</span></span>
