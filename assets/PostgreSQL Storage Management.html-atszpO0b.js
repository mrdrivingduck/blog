...
<span class="line">    <span class="token punctuation">}</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="smgrreadv-smgrwritev" tabindex="-1"><a class="header-anchor" href="#smgrreadv-smgrwritev"><span>smgrreadv / smgrwritev</span></a></h3><p>在物理文件和内存 buffer 之间交换数据。其使用者为缓冲区管理模块。</p><h3 id="smgrnblocks-smgrnblocks-cached" tabindex="-1"><a class="header-anchor" href="#smgrnblocks-smgrnblocks-cached"><span>smgrnblocks / smgrnblocks_cached</span></a></h3><p>获取物理文件中的数据块数量，本质上为获取文件长度后除以数据块大小。其使用者为：</p><ul><li>缓冲区管理模块读取数据块时</li><li>物理文件的拷贝/扩展时</li><li>优化器的代价估算时</li></ul><p><code>smgrnblocks</code> 会将结果缓存在进程私有内存中，<code>smgrnblocks_cached</code> 将会直接返回上一次调用 <code>smgrnblocks</code> 的缓存值。根据 <a href="https://www.postgresql.org/message-id/flat/CAEepm%3D3SSw-Ty1DFcK%3D1rU-K6GSzYzfdD4d%2BZwapdN7dTa6%3DnQ%40mail.gmail.com" target="_blank" rel="noopener noreferrer">社区邮件</a> 的讨论，频繁调用 <code>smgrnblocks</code>（本质上是对物理文件的 <code>lseek(SEEK_END)</code>）将会对性能有一定影响，但目前又缺少文件长度发生变化时的同步机制，所以暂时只在 <a href="https://github.com/postgres/postgres/commit/c5315f4f44843c20ada876fdb0d0828795dfbdf5" target="_blank" rel="noopener noreferrer">recovery 阶段使用缓存值</a>，因为此时是单进程执行的。在文件大小发生变化的存储管理层接口中（extend / truncate），也需要同步更新这个缓存值，或直接使这个缓存值失效。</p><div class="language-c line-numbers-mode" data-highlighter="prismjs" data-ext="c" data-title="c"><pre><code><span class="line"><span class="token comment">/*</span>
