import{_ as n,c as s,o as a,a as e}from"./app-zsROWd52.js";const i={},l=e(`<h1 id="cryptography-java-实现对称与非对称加密算法" tabindex="-1"><a class="header-anchor" href="#cryptography-java-实现对称与非对称加密算法"><span>Cryptography - Java 实现对称与非对称加密算法</span></a></h1><p>Created by : Mr Dk.</p><p>2018 / 05 / 26 23:45</p><p>Nanjing, Jiangsu, China</p><hr><h2 id="_1-对称加密算法-symmetric-encryption-algorithm" tabindex="-1"><a class="header-anchor" href="#_1-对称加密算法-symmetric-encryption-algorithm"><span>1. 对称加密算法 （Symmetric Encryption Algorithm）</span></a></h2><p>数据发信方将明文（原始数据）和加密密钥一起经过特殊加密算法处理后，使其变成复杂的加密密文发送出去。收信方收到密文后，若想解读原文，则需要使用加密用过的密钥及相同算法的逆算法对密文进行解密，才能使其恢复成可读明文。</p><ul><li>密钥只有一个，发收信双方都使用这个密钥对数据进行加密和解密</li><li>发送方和接收方在安全通信之前，需要提前商定密钥</li></ul><h3 id="优点" tabindex="-1"><a class="header-anchor" href="#优点"><span>优点</span></a></h3><ul><li>算法公开</li><li>计算量小</li><li>加密速度快</li><li>加密效率高</li></ul><h3 id="缺点" tabindex="-1"><a class="header-anchor" href="#缺点"><span>缺点</span></a></h3><ul><li>安全性问题</li><li>密钥泄露将有灾难性后果</li></ul><h3 id="典型算法" tabindex="-1"><a class="header-anchor" href="#典型算法"><span>典型算法</span></a></h3><ul><li><em>DES</em> 算法</li><li><em>3DES</em> 算法</li><li><em>RC5</em> 算法</li><li><em>AES</em> 算法</li></ul><h3 id="实现-aes-算法" tabindex="-1"><a class="header-anchor" href="#实现-aes-算法"><span>实现 （AES 算法）</span></a></h3><div class="language-Java line-numbers-mode" data-highlighter="prismjs" data-ext="Java" data-title="Java"><pre class="language-Java"><code><span class="line">package cn.zjt.iot.oncar.util;</span>
