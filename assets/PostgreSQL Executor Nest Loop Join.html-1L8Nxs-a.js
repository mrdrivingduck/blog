import{_ as n,c as s,o as a,a as e}from"./app-zsROWd52.js";const p={},l=e(`<h1 id="postgresql-executor-nest-loop-join" tabindex="-1"><a class="header-anchor" href="#postgresql-executor-nest-loop-join"><span>PostgreSQL - Executor: Nest Loop Join</span></a></h1><p>Created by : Mr Dk.</p><p>2021 / 07 / 09 22:25</p><p>Hangzhou, Zhejiang, China</p><hr><p>实现关系代数中的连接操作。连接分为逻辑上的和物理上的，逻辑上的连接可以由物理上的连接来实现，每种物理连接都有其可以实现的逻辑连接类型。</p><h2 id="逻辑连接" tabindex="-1"><a class="header-anchor" href="#逻辑连接"><span>逻辑连接</span></a></h2><p>PostgreSQL 中已经定义了如下几种逻辑 join 类型：</p><div class="language-c line-numbers-mode" data-highlighter="prismjs" data-ext="c" data-title="c"><pre class="language-c"><code><span class="line"><span class="token comment">/*</span>
