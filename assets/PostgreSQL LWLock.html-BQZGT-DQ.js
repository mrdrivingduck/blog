import{_ as l,r as i,c as t,b as n,e as s,d as e,w as p,a as c,o}from"./app-zsROWd52.js";const u={},r=n("h1",{id:"postgresql-lwlock",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#postgresql-lwlock"},[n("span",null,"PostgreSQL - LWLock")])],-1),d=n("p",null,"Created by: Mr Dk.",-1),k=n("p",null,"2023 / 11 / 29 16:40",-1),v=n("p",null,"Hangzhou, Zhejiang, China",-1),m=n("hr",null,null,-1),b=n("h2",{id:"background",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#background"},[n("span",null,"Background")])],-1),h=c(`<p>本文基于 PostgreSQL <code>master</code> 分支（PostgreSQL 17 under dev）当前的 <code>HEAD</code> 版本分析原子操作的实现：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre class="language-text"><code><span class="line">commit 15c9ac3629936a9bb5010155d3656e913027ccb7</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>LWLock 的锁模式：</p><div class="language-c line-numbers-mode" data-highlighter="prismjs" data-ext="c" data-title="c"><pre class="language-c"><code><span class="line"><span class="token keyword">typedef</span> <span class="token keyword">enum</span> <span class="token class-name">LWLockMode</span></span>
<span class="line"><span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>LWLock 的锁状态位：</p><ul><li><code>LW_FLAG_HAS_WAITERS</code>：是否存在等待进程</li><li><code>LW_FLAG_RELEASE_OK</code>：在释放锁时立刻唤醒等待进程</li><li><code>LW_FLAG_LOCKED</code>：正在修改 LWLock 内的等待进程列表</li></ul><div class="language-c line-numbers-mode" data-highlighter="prismjs" data-ext="c" data-title="c"><pre class="language-c"><code><span class="line"><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">define</span> <span class="token macro-name">LW_FLAG_HAS_WAITERS</span>         <span class="token expression"><span class="token punctuation">(</span><span class="token punctuation">(</span>uint32<span class="token punctuation">)</span> <span class="token number">1</span> <span class="token operator">&lt;&lt;</span> <span class="token number">30</span><span class="token punctuation">)</span></span></span></span>
...
<span class="line">    <span class="token punctuation">}</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,45);function L(_,w){const a=i("RouteLink");return o(),t("div",null,[r,d,k,v,m,b,n("p",null,[s("PostgreSQL 中的轻量级锁 LWLock（Light Weight Lock）用于互斥访问共享内存中的数据结构。与 "),e(a,{to:"/notes/PostgreSQL/PostgreSQL%20Atomics.html"},{default:p(()=>[s("原子操作")]),_:1}),s(" 和 "),e(a,{to:"/notes/PostgreSQL/PostgreSQL%20Spinlock.html"},{default:p(()=>[s("自旋锁")]),_:1}),s(" 不同，LWLock 引入了读写访问模式，使其可以被不同进程共享访问或排它访问。实际上 LWLock 就是结合原子操作和自旋实现的，也引入了信号量。另外 LWLock 也支持对某个共享变量的值进行修改和监视，但应用场景相对较少。")]),h])}const g=l(u,[["render",L],["__file","PostgreSQL LWLock.html.vue"]]),y=JSON.parse('{"path":"/notes/PostgreSQL/PostgreSQL%20LWLock.html","title":"PostgreSQL - LWLock","lang":"en-US","frontmatter":{},"headers":[{"level":2,"title":"Background","slug":"background","link":"#background","children":[]},{"level":2,"title":"Data Structure And States","slug":"data-structure-and-states","link":"#data-structure-and-states","children":[]},{"level":2,"title":"Operations","slug":"operations","link":"#operations","children":[{"level":3,"title":"Initialization","slug":"initialization","link":"#initialization","children":[]},{"level":3,"title":"Lock Up","slug":"lock-up","link":"#lock-up","children":[]},{"level":3,"title":"Conditional Lock Up","slug":"conditional-lock-up","link":"#conditional-lock-up","children":[]},{"level":3,"title":"Lock Or Wait","slug":"lock-or-wait","link":"#lock-or-wait","children":[]},{"level":3,"title":"Release","slug":"release","link":"#release","children":[]}]}],"git":{"updatedTime":null,"contributors":[]},"filePathRelative":"notes/PostgreSQL/PostgreSQL LWLock.md"}');export{g as comp,y as data};
