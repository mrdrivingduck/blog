import{_ as n,c as s,o as a,a as e}from"./app-zsROWd52.js";const p={},l=e(`<h1 id="chapter-9-1-9-3-事件处理框架" tabindex="-1"><a class="header-anchor" href="#chapter-9-1-9-3-事件处理框架"><span>Chapter 9.1-9.3 - 事件处理框架</span></a></h1><p>Created by : Mr Dk.</p><p>2020 / 07 / 20 20:19</p><p>Nanjing, Jiangsu, China</p><hr><h2 id="_9-1-事件模块的层次定义" tabindex="-1"><a class="header-anchor" href="#_9-1-事件模块的层次定义"><span>9.1 事件模块的层次定义</span></a></h2><p>事件处理框架负责收集、管理、分发事件。事件以网络事件和定时器事件为主，网络事件中以 TCP 网络事件为主。Nginx 为不同的操作系统和不同的操作系统版本提供了多种 <strong>事件驱动机制</strong> (也叫 <strong>I/O 多路复用</strong>)。</p><p>Nginx 定义了核心模块 <code>ngx_events_module</code>，使得能够在启动时解析配置项。其次，Nginx 定义了事件模块 <code>ngx_event_core_module</code>，决定使用哪种事件管理机制。Nginx 目前定义了 9 个运行在不同 OS、不同 OS 版本上的事件驱动模块，在模块初始化过程中，将选取一个作为事件驱动模块。</p><p>正好看一看关于模块层次的抽象。Nginx 首先定义了模块的最抽象接口。这一层模块接口，我觉得可以从三个部分来看：</p><ol><li>模块标识 (编号和名称)，不仅包括模块在所有 Nginx 模块里的编号，还包括模块在某类 Nginx 模块里的编号</li><li>模块类型、参数、上下文</li><li>模块的生命周期函数指针 (<code>init_...</code> / <code>exit_...</code>)</li></ol><div class="language-c line-numbers-mode" data-highlighter="prismjs" data-ext="c" data-title="c"><pre class="language-c"><code><span class="line"><span class="token keyword">struct</span> <span class="token class-name">ngx_module_s</span> <span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_9-2-nginx-事件的定义" tabindex="-1"><a class="header-anchor" href="#_9-2-nginx-事件的定义"><span>9.2 Nginx 事件的定义</span></a></h2><p>在 Nginx 中，每个事件都由 <code>ngx_event_t</code> 结构体来表示，其中绝大部分为标志位：</p><div class="language-c line-numbers-mode" data-highlighter="prismjs" data-ext="c" data-title="c"><pre class="language-c"><code><span class="line"><span class="token keyword">struct</span> <span class="token class-name">ngx_event_s</span> <span class="token punctuation">{</span></span>
...
<span class="line"><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">endif</span></span></span>
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">;</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_9-3-2-主动连接" tabindex="-1"><a class="header-anchor" href="#_9-3-2-主动连接"><span>9.3.2 主动连接</span></a></h3><p>Nginx 主动向其它服务器发起的连接。</p><div class="language-c line-numbers-mode" data-highlighter="prismjs" data-ext="c" data-title="c"><pre class="language-c"><code><span class="line"><span class="token keyword">typedef</span> <span class="token keyword">struct</span> <span class="token class-name">ngx_peer_connection_s</span>  <span class="token class-name">ngx_peer_connection_t</span><span class="token punctuation">;</span></span>
<span class="line"></span>
