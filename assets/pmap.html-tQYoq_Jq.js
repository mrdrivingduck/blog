import{_ as n,c as a,a as e,o as l}from"./app-7eKjwDat.js";const p={};function i(c,s){return l(),a("div",null,s[0]||(s[0]=[e(`<h1 id="pmap" tabindex="-1"><a class="header-anchor" href="#pmap"><span>pmap</span></a></h1><p>Created by : Mr Dk.</p><p>2023 / 07 / 03 23:04</p><p>Hangzhou, Zhejiang, China</p><hr><h2 id="background" tabindex="-1"><a class="header-anchor" href="#background"><span>Background</span></a></h2><p><code>pmap</code> 用于打印进程的内存映射情况。其数据来源于 <code>/proc/PID/smaps</code>，并被加工为用户友好的阅读形式。</p><h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage"><span>Usage</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">$ pmap <span class="token parameter variable">--help</span></span>
