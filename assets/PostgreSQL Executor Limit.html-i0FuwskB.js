import{_ as n,c as s,o as a,a as e}from"./app-Cr4rVnZM.js";const p={},l=e(`<h1 id="postgresql-executor-limit" tabindex="-1"><a class="header-anchor" href="#postgresql-executor-limit"><span>PostgreSQL - Executor: Limit</span></a></h1><p>Created by : Mr Dk.</p><p>2021 / 07 / 14 01:02</p><p>Hangzhou, Zhejiang, China</p><hr><p><code>Limit</code> 节点用于限制返回的元组行数。当 <code>Limit</code> 节点从孩子节点获取指定数量的元组后，就结束查询，不再递归调用 <code>ExecProcNode()</code> 获取元组了。</p><h2 id="plan-node" tabindex="-1"><a class="header-anchor" href="#plan-node"><span>Plan Node</span></a></h2><p><code>Limit</code> 节点还真没有看起来这么简单：</p><div class="language-c line-numbers-mode" data-highlighter="prismjs" data-ext="c" data-title="c"><pre class="language-c"><code><span class="line"><span class="token comment">/*</span>
