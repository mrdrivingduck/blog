import{_ as n,c as s,o as a,a as e}from"./app-zsROWd52.js";const l={},p=e(`<h1 id="postgresql-executor-sequential-scan" tabindex="-1"><a class="header-anchor" href="#postgresql-executor-sequential-scan"><span>PostgreSQL - Executor: Sequential Scan</span></a></h1><p>Created by : Mr Dk.</p><p>2021 / 06 / 27 23:42</p><p>Hangzhou, Zhejiang, China</p><hr><p>对 PostgreSQL 执行器的执行流程进行分析后，看看最简单的顺序扫描算子是如何实现的。</p><h2 id="plan-node" tabindex="-1"><a class="header-anchor" href="#plan-node"><span>Plan Node</span></a></h2><p>优化器输出的查询计划树是二叉树的形式。二叉树的节点有着最基本的结构定义，并根据不同类型的操作实现继承关系。最基本的计划树节点的结构定义如下。其中，由 <code>type</code> 来指定计划节点的类型。</p><div class="language-c line-numbers-mode" data-highlighter="prismjs" data-ext="c" data-title="c"><pre class="language-c"><code><span class="line"><span class="token comment">/* ----------------</span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>顺序扫描已经是最简单的扫描算子了，后续考虑看一下索引扫描算子，看看实现上有什么特别的地方。暂时没有向下研究至存储级别的实现：heap 表似乎定义了自己的 access method，与具体扫描操作的实现解耦。</p>`,35),i=[p];function c(t,o){return a(),s("div",null,i)}const d=n(l,[["render",c],["__file","PostgreSQL Executor Sequential Scan.html.vue"]]),r=JSON.parse('{"path":"/notes/PostgreSQL/PostgreSQL%20Executor%20Sequential%20Scan.html","title":"PostgreSQL - Executor: Sequential Scan","lang":"en-US","frontmatter":{},"headers":[{"level":2,"title":"Plan Node","slug":"plan-node","link":"#plan-node","children":[]},{"level":2,"title":"Initialization","slug":"initialization","link":"#initialization","children":[]},{"level":2,"title":"Sequential Scan Execution","slug":"sequential-scan-execution","link":"#sequential-scan-execution","children":[]},{"level":2,"title":"Ending","slug":"ending","link":"#ending","children":[]}],"git":{"updatedTime":null,"contributors":[]},"filePathRelative":"notes/PostgreSQL/PostgreSQL Executor Sequential Scan.md"}');export{d as comp,r as data};
