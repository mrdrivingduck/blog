import{_ as i,c as l,b as s,e as a,d as p,w as t,a as c,r as o,o as d}from"./app-DfFNXaa-.js";const r={};function u(v,n){const e=o("RouteLink");return d(),l("div",null,[n[3]||(n[3]=s("h1",{id:"postgresql-walbufmappinglock",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#postgresql-walbufmappinglock"},[s("span",null,"PostgreSQL - WALBufMappingLock")])],-1)),n[4]||(n[4]=s("p",null,"Created by: Mr Dk.",-1)),n[5]||(n[5]=s("p",null,"2025 / 08 / 09 20:19",-1)),n[6]||(n[6]=s("p",null,"Hangzhou, Zhejiang, China",-1)),n[7]||(n[7]=s("hr",null,null,-1)),n[8]||(n[8]=s("h2",{id:"背景",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#背景"},[s("span",null,"背景")])],-1)),s("p",null,[n[1]||(n[1]=a("在 ",-1)),p(e,{to:"/notes/PostgreSQL/PostgreSQL%20WAL%20Insert.html"},{default:t(()=>[...n[0]||(n[0]=[a("PostgreSQL - WAL Insert",-1)])]),_:1}),n[2]||(n[2]=a(" 中已经分析过，当多个进程想要并发记录 WAL 日志时，需要先串行地在 WAL 日志中分配预留空间，然后再各自获取 WALInsertLock 并发地将 WAL 日志拷贝到预留空间所对应的 WAL Buffer 中。在进行拷贝之前，如果 WAL Buffer 对应空间中的被替换页面还没来得及写入存储，则需要获取 WALWriteLock 将日志写到存储，然后获取 WALBufMappingLock 将这个页面重新初始化，才能开始使用。",-1))]),n[9]||(n[9]=c(`<p>在写入较重的场景中，特别是数据导入场景，一条内容密集的 WAL 日志可能会横跨多个 WAL 日志页面。以索引创建为例，一条未被压缩的 XLOG FPI 日志达到了 229 kB；即使设置 <code>wal_compression</code> 使用 ZSTD 压缩算法，也能够达到 61 kB：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">=&gt; SELECT * FROM pg_get_wal_record_info(&#39;1/0C15A768&#39;);</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如图所示：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">     initializing</span>
<span class="line">        |&lt;-&gt;|</span>
<span class="line">+---+---+---+---+---+---+---+------+</span>
...
<span class="line">    <span class="token comment">/* ... */</span></span>
<span class="line"><span class="token punctuation">}</span> XLogCtlData<span class="token punctuation">;</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code>InitializeReserved</code> 指向已经开始初始化的最新页面的结束地址，与 <code>InitializedUpTo</code> 形成了一段 <em>正在初始化</em> 的 WAL Buffer 页面区间，多个进程可以在这个区间中对页面进行并发 <code>memset</code> 清零以及页面映射关系修改。如图所示：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">              initializing</span>
<span class="line">        |&lt;---------------------&gt;|</span>
<span class="line">+---+---+---+---+---+---+---+---+---+------+</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如图所示：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">   To Be Replaced         To Be Initialized</span>
<span class="line">        |&lt;-&gt;|                   |&lt;-&gt;|</span>
